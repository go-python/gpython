...
var (
	...
	// This is exposed for advanced testing where a single test script drives multiple gold outputs.
	GoldFileSuffix = "_golden.txt"
)

type Task struct {
	num      int32                      // Assigned when this task is run
	ID       string                     // unique key identifying this task.  If empty, this is autogenerated from a PyFile derivative
